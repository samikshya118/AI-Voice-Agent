...
async def websocket_endpoint(websocket: WebSocket):
    ...
    # Task: read audio from frontend and put into queue
    ...
    # Task: stream to AssemblyAI and send transcripts back
    transcriber = asyncio.create_task(
        stream_transcription(websocket, audio_queue, ASSEMBLYAI_API_KEY)
    )

    await asyncio.gather(receive_audio(), transcriber)
